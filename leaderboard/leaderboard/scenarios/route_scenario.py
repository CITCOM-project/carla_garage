...
class RouteScenario(BasicScenario):
    ...
    def _initialize_actors(self, config):
        ...
        new_actors = CarlaDataProvider.request_new_batch_actors(
            "vehicle.*", amount, carla.Transform(), autopilot=True, random_location=True, rolename="background"
        )
    ...
    def _create_test_criteria(self):
        ...
        stop_criterion = RunningStopTest(self.ego_vehicles[0], terminate_on_failure=True)
